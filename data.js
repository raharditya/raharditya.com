        ...
        body: [
          {
            type: "p",
            content:
              "Aplikasi berbasis website ini saya buat dalam rangka Kuliah Kerja Nyata yang harus dilakukan secara online karena terjadinya pandemi Covid-19. Project ini adalah salah satu program kerja dalam rangka mengedukasi masyarakat mengenai pandemi Covid-19 serta kebiasaan New Normal.",
          },
          {
            type: "p",
            content:
              "Dalam aplikasi berbasis website ini, terdapat informasi kasus Covid-19 dalam cakupan Provinsi Daerah Istimewa Yogyakarta sampai tiap kabupaten dan kecamatan yang ada di Provinsi DIY dan diperbarui secara otomatis setiap harinya. Selain itu juga terdapat berita terkait Covid-19 dari 5 sumber yang berbeda yang diperbarui secara otomatis setiap dua jam sekali. Ada pula berbagai artikel dan informasi hoax yang dikumpulkan secara manual oleh tim KKN.",
          },
        ],
      },
    ],
