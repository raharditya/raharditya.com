function about(props) {
  return (
    <div className="pt-24 md:container md:mx-auto">
      <h2 className="px-6 text-heading-serif page-heading font-bold text-4xl mb-8 md:text-5xl">
        About
        <br />
        Me
      </h2>
      ...
      <div className="md:flex flex-row-reverse">
        ...
        <div className="w-11/12 backdrop py-16 px-8 mb-8 md:absolute md:-top-4 md:w-1/2 md:left-0">
